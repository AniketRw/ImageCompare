# FILE: compare_api.py (The Comparison/Validation API Server)
import os
import json
import io
import traceback
...
import configparser
import pyodbc 
import onnxruntime as ort # Required for model inference
...
# MATCH_THRESHOLD set to 0.40 for a balance (as discussed)
MATCH_THRESHOLD = 0.40 
TOP_K_NEIGHBORS = 5 # Use the robust multi-neighbor check
...
# --- Database & Model Functions (Required for the comparison API) ---
...
if __name__ == "__main__":
    # Runs the comparison server on a separate port (e.g., 5055)
    uvicorn.run("compare:app", host="0.0.0.0", port=5055, reload=False)